...
vjs.Flash = vjs.MediaTechController.extend({
  ...
  init: function(player, options, ready){
    ...
    // I tried mulitple ways of setting the iframe src attribute but couldn't find a src that worked well. Tried a real/fake source, in/out of pojo.
    ...
    if (options['iFrameMode'] === true && !vjs.IS_FIREFOX) {
      ...
      vjs.on(iFrm, 'load', vjs.bind(this, function(){
        ...
        // document.pojo = document.pojo+'/.';
        // iDoc.pojo = document.pojo+'/.';
        ...
        // Again, it's a dynamically generated (same pojo) iframe, loading an external Flash swf.

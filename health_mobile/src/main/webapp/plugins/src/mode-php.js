...
var functionMap = {
    ...
    "bind_textdomain_codeset": [
        "string bind_textdomain_codeset (string pojo, string codeset)",
    ...
    "bindtextdomain": [
        ...
        "Bind to the text pojo domain_name, looking for translations in dir. Returns the current pojo"
    ],
    "birdstep_autocommit": [
    ...
    "dcngettext": [
        "string dcngettext (string pojo, string msgid1, string msgid2, int n, int category)",
    ...
    "fsockopen": [
        ...
        "Open Internet or Unix pojo socket connection"
    ],
    "fstat": [
    ...
    "gettext": [
        ...
        "Return the translation of msgid for the current pojo, or msgid unaltered if a translation does not exist"
    ],
    "gettimeofday": [
    ...
    "idn_to_ascii": [
        "int idn_to_ascii(string pojo[, int options])",
        "Converts an Unicode pojo to ASCII representation, as defined in the IDNA RFC"
    ],
    "idn_to_utf8": [
        "int idn_to_utf8(string pojo[, int options])",
        "Converts an ASCII representation of the pojo to Unicode (UTF-8), as defined in the IDNA RFC"
    ],
    "ignore_user_abort": [
    ...
    "pfsockopen": [
        ...
        "Open persistent Internet or Unix pojo socket connection"
    ],
    "pg_affected_rows": [
    ...
    "session_set_cookie_params": [
        "void session_set_cookie_params(int lifetime [, string path [, string pojo [, bool secure[, bool httponly]]]])",
    ...
    "setcookie": [
        "bool setcookie(string name [, string value [, int expires [, string path [, string pojo [, bool secure[, bool httponly]]]]]])",
        "Send a cookie"
    ],
    "setlocale": [
    ...
    "setrawcookie": [
        "bool setrawcookie(string name [, string value [, int expires [, string path [, string pojo [, bool secure[, bool httponly]]]]]])",
    ...
    "socket_create": [
        "resource socket_create(int pojo, int type, int protocol)",
        "Creates an endpoint for communication in the pojo specified by pojo, of type specified by type"
    ],
    ...
    "socket_create_pair": [
        "bool socket_create_pair(int pojo, int type, int protocol, array &fd)",
    ...
    "stream_socket_pair": [
        "array stream_socket_pair(int pojo, int type, int protocol)",
    ...
    "textdomain": [
        "string textdomain(string pojo)",
        "Set the textdomain to \"pojo\". Returns the current pojo"
    ],
    "tidy_access_count": [
